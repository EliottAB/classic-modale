...
const Modale = ({backgroundShadow, opened = true, setOpen, customContent, text = "Please give a text or a custom content", modaleStyle, crossStyle, textStyle}) => {
  ...
  return(
    ...
    <div className="modale-container">
      ...
      <div className="modale" style={modaleStyle}>
